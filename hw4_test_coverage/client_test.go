...
func TestLimit(t *testing.T) {
	...
	res, err := client.FindUsers(SearchRequest{Query: "on", OrderField: "Age", OrderBy: OrderByAsIs, Limit: 30, Offset: 0})
	if err != nil {
	...
	_, err = client.FindUsers(SearchRequest{Query: "on", OrderField: "Age", OrderBy: OrderByAsIs, Limit: 30, Offset: -1})
	if err == nil {
		t.Errorf("Ofset less then 0 not processed")
	}
}
...
func TestTimeout(t *testing.T) {
	...
	_, err := client.FindUsers(SearchRequest{Query: "on", OrderField: "Age", OrderBy: OrderByAsIs, Limit: 30, Offset: 0})
	if err == nil {
		t.Errorf("Server timeout not processed")
	}
}
...
func TestStatusBadRequest(t *testing.T) {
	...
	_, err := client.FindUsers(SearchRequest{Query: "on", OrderField: "Age", OrderBy: OrderByAsIs, Limit: 30, Offset: 0})
	if err == nil {
		t.Errorf("Server StatusBadRequest not processed")
	}
}
...
func TestErrorBadOrderField(t *testing.T) {
	...
	_, err := client.FindUsers(SearchRequest{Query: "on", OrderField: "Age", OrderBy: OrderByAsIs, Limit: 30, Offset: 0})
	if err == nil {
		t.Errorf("ErrorBadOrderField not processed")
	}
}

func TestUnckownBadRequestError(t *testing.T) {
	ts := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		w.WriteHeader(http.StatusBadRequest)
		resp, _ := json.Marshal(SearchErrorResponse{Error: "UnckownBadRequestError"})
		w.Write(resp)
	}))
	defer ts.Close()
	client := SearchClient{
	...
	_, err := client.FindUsers(SearchRequest{Query: "on", OrderField: "Age", OrderBy: OrderByAsIs, Limit: 30, Offset: 0})
	if err == nil {
		t.Errorf("UnckownBadRequestError not processed")
	}
}

func TestUnmarshalBodyError(t *testing.T) {
	ts := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		w.WriteHeader(http.StatusOK)
		w.Write([]byte{})
	}))
	...
	_, err := client.FindUsers(SearchRequest{Query: "on", OrderField: "Age", OrderBy: OrderByAsIs, Limit: 30, Offset: 0})
	if err == nil {
		t.Errorf("UnmarshalBodyError not processed")
	}
}
...
func TestLenDataNotEqualLimit(t *testing.T) {
	...
	_, err := client.FindUsers(SearchRequest{Query: "on", OrderField: "Age", OrderBy: OrderByAsIs, Limit: 30, Offset: 0})
	if err != nil {
		t.Errorf("Got data lenght not equal limit not processed")
	}
}
